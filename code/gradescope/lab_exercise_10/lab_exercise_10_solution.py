...
# SWAPI call
vader = requests.get(resource_uri, params={"search": "darth vader"}).json()

# Forgo web service call
# with open('test_darth_vader.json', 'r') as file_obj:
